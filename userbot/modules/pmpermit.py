...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = ("`Bro Please Try To Sought It Out Yourself`\n\n"
                  "`I Am Offline And Will Be Back By two years`"
                  "`Always remember noone is born pro.`\n\n"
                  "`I Hope You Understand it - a Message By My Userbot `")
# =================================================================
